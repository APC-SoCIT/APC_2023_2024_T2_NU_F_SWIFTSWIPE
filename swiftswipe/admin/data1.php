                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            ...
                            <li class="app-sidebar__heading">Home</li>
                                ...
                                <li>
                                <a href="../admin/time-out.php" class="mm-active">
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div><a href="../time-out/index.php">View All Time Out</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <form action="data.php1" method="GET">
                                    <div class="input-group">
                                   
                                    <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" placeholder="Student Number">
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $query = "SELECT * FROM attendance_out WHERE student_no LIKE '%$filtervalues%' ";
