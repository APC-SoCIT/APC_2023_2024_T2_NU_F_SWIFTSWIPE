                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            ...
                            <li class="app-sidebar__heading">Home</li>
                                ...
                                <li >
                                    <a href="archive.php" class="mm-active">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Student Archive
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM archive ORDER BY id");
                                                        ?>
                                            ...
                                            echo"<tr>";
                                                        ...
                                                        echo "<a href='../admin/restore.php?id=$user_data[id]' class='btn btn-primary btn-sm m-1'><i class='fa-solid fa-rotate-right'></i> Restore</a>";
                                                        echo "</td>";
                                                        echo "</tr>";
                                                        echo "</tr>";
                                                        echo "</tbody>";
