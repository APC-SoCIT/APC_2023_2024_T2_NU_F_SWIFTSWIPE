                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" placeholder="Search Student Number">
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $query = "SELECT * FROM attendance_in WHERE student_no LIKE '%$filtervalues%' ";
