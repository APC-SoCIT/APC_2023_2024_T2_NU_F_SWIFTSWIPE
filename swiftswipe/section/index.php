                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header"><a class='btn btn-success btn-xl'  href="add.php"><i class="fa-solid fa-plus"></i> Add New Section</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            echo"<tbody>";
                                            echo"<tr>";
                                                        echo "<td class='text-center text-muted'>$user_data[sectionname]</td>";
                    
                                                        echo "<td class='text-center'>";
                                                        echo "<a href='delete.php?id=$user_data[id]' class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> Delete</a>";
                                                        echo "</td>";
