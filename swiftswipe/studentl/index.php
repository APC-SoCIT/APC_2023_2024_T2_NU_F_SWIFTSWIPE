                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header"><a class='btn btn-success btn-xl'  href="add.php"><i class="fa-solid fa-plus"></i> Add New Student</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            echo"<tr>";
                                                        ...
                                                        echo "<div class='widget-subheading opacity-7'>$user_data[grade]</div>";
                                                        echo "</div>";
                                                        echo "</div>";
                                                        echo "</div>";
                                                        echo "</td>";
                                                        ...
                                                        echo "<a class='btn btn-success btn-sm m-1' href='update.php?id=$user_data[id]'><i class='fa-solid fa-pen-to-square fa-xl'></i> Edit</a>";
                                                        echo "<a href='delete.php?id=$user_data[id]' class='btn btn-danger btn-sm m-1'><i class='fa-solid fa-box-archive'></i> Archive</a>";
                                                        echo "</td>";
                                                        echo "</tr>";
                                                        echo "</tr>";
                                                        echo "</tbody>";
