                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header"><a class='btn btn-success btn-xl'  href="add.php"><i class="fa-solid fa-plus"></i> Add New Strand</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM strand");
                                                        ?>
                                            ...
                                            echo"<tbody>";
                                            echo"<tr>";
                                                        echo "<td class='text-center text-muted'>$user_data[strandcode]</td>";
                                                        echo "<td class='text-center text-muted'>$user_data[strandname]</td>";
