                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header"><a class='btn btn-success btn-xl'  href="register.php"><i class="fa-solid fa-plus"></i> Add New Admin</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM admint");
                                                        ?>
                                            ...
                                            echo "<div class='widget-subheading opacity-7'>Administrator</div>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</td>";
