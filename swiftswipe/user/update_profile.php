...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div>
         <span>Email:</span>
         <input type="email" name="update_email" value="<?php echo $fetch['email']; ?>" class="input1">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="email" name="update_email" value="<?php echo $fetch['department']; ?>" class="box" disabled >
         </div>
         <div class="inputBox">
