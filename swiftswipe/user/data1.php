      ...
      <div class="dropdown">
        ...
        <body style="background:#0d6efd;">  
                          ...
                          <div class="row m-5">
                            ...
                            <div class="col-md-12">
                            <h3 class="text-center p-3" style="color:white;"><?php echo $_GET['search'] ?> Monthy Attendance Report</h3>
                                <div class="main-card mb-3 card">
                                    <div class="card-header ">
                                    <a class="m-1" href="export1.php?c=<?php echo $_GET['search']?>"><button class="btn btn-success btn-xl m-1">Export to Excel</button></a>
                                    ...
                                    <?php 
                                    $date = date('F');
                                    echo '<p class="m-2"></i><strong>'.$row.'</strong> Days Present Month of '.$date.'</p>' ?>
                                    </div>
                                </div>
                            </div>
                        </div>
